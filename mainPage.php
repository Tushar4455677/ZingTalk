...
<head>
    ...
    top: 50px;
    left: 800px;
    width: 38%;  /* ✅ अब container की width 45% होगी */
    display: flex;
    gap: 10px;
    padding: 10px;
    overflow-x: auto; /* ✅ ज्यादा स्टोरी होने पर horizontal scroll आएगा */
    white-space: nowrap;
    margin-left:10px;
...
.story-icon p {
    color: red; /* ✅ Username का text blue होगा */
    font-weight: bold; /* (Optional) थोड़ा bold दिखाने के लिए */
    font-size: 14px;
    margin-top:9px; /* (Optional) Font size set करने के लिए */
}
...
@media (max-width: 768px) {
    ...
    @media (min-width: 768px) {
        .container {
            margin-left: 350px; /* Sidebar के पास Perfect Position */
            max-width: 400px;
        }
    }
    ...
    .image-container {
        position: absolute;
        top: 30%; /* ऊपर से 30% gap */
        right: 120px; /* राइट से थोड़ा gap */
        display: flex;
    ...
    @media (max-width: 768px) {
        ...
        .image-container img {
            width: 180px; /* मोबाइल पर थोड़ा छोटा */
        }
    }
    </style>
</head>
...
<div class="popup-overlay" id="popup">
    <div class="popup-box">
        <form id="storyForm" enctype="multipart/form-data">
            <!-- <input type="text" name="story_text" id="story_text" placeholder="Enter Title" required><br><br> -->
...
<script>
    ...
    $.post("like.php", { post_id: post_id }, function(response) {
        if (response === "liked") {
            button.text("Unlike");
...
$(document).on("submit", ".comment-form", function(e) {
    ...
    $.post("comment.php", { post_id: post_id, comment: comment }, function(response) {
